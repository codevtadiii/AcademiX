...
const Dashboard = () => {
  ...
  const handleSignOut = () => {
    // Clear any authentication-related data if necessary (e.g., localStorage)
    localStorage.removeItem("authToken"); // Example: Clearing stored authentication token
  ...
  return (
    <div className="dashboard">
      ...
      <div className="header bg-blue-700 text-white p-4 flex justify-between items-center shadow-md">
        <h2 className="text-xl font-bold">AcademiX</h2>
      ...
      {sidebarVisible && (
        <div className="sidebar fixed top-0 left-0 h-full w-64 bg-gray-800 text-white p-4">
          <ul className="space-y-4">
            ...
            <li>
              <button
                onClick={handleSignOut} // Updated Sign Out button
