    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm py-4">
        <div className="container mx-auto flex justify-between items-center px-6">
          ...
          <div>
            <button
              className="px-4 py-2 text-gray-700 border border-gray-300 rounded-md mr-4 hover:bg-gray-100"
      ...
      <section className="bg-white text-center py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-8">
            <button
              className="px-6 py-3 bg-blue-700 text-white rounded-md text-lg mr-4 hover:bg-blue-800"
              onClick={() => navigate("/signup")}
            >
              Get Started Now
            </button>
            <button
              className="px-6 py-3 bg-gray-100 text-gray-700 border border-gray-300 rounded-md text-lg hover:bg-gray-200"
              onClick={() => navigate("/login")}
            >
              Sign In
            </button>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800">Project Collaboration</h3>
              <p className="text-gray-600 mt-2">
            ...
            <div className="bg-white shadow-md rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800">Skill Enhancement</h3>
              <p className="text-gray-600 mt-2">
